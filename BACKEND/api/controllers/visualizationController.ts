...
export const postVisualization = async (req: RequestWithUser, res: Response) => {
  const {
    type,
    title,
    library,
...
export const getVisualizations = async (req: RequestWithUser, res: Response) => {
  const owner = req.user.id;
...
export const deleteVisualization = async (req: RequestWithUser, res: Response) => {
  const { id } = req.params;
  const owner = req.user.id;
...
export const getVisualizationsById = async (req: RequestWithUser, res: Response) => {
  const { id } = req.params;
  const owner = req.user.id;
...
export const getVisualizationsCount = async (req: RequestWithUser, res: Response) => {
  const owner = req.user.id;
